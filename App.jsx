...
function App() {
  ...
  const { activeVoicing } = useChordVoicings(mode === "strum");
  ...
  const marks = useMemo(() => {
    ...
    return map;
  }, [mode, activeVoicing, chordRoot, midis, n, activeProg, activeProgVoicing, melSteps, melPlayIdx, melCursor, melKeyHint]);
