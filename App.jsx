...
const FAQS = FAQ_SECTIONS.flatMap((s) => s.items);

/* User-facing "What's new". Highlights only, newest group first, plain language.
   The full record lives in CHANGELOG.md; this is the short version a player sees
   on the About page so it is clear the app is looked after and improving. */
const CHANGELOG = [
  {
    date: "August 2026",
    items: [
      ...
      "Ear training for intervals and chords, with streaks and badges.",
      "Fretboard Quiz for learning the note names across the neck.",
    ],
  },
];
...
.faqjump{margin:0 14px 13px; font-size:12px; color:var(--goldtext); border-color:var(--line2)}
.faqtoc{margin-top:2px; gap:8px}
.faq-pane .abouthead{scroll-margin-top:76px}
.release{display:grid; gap:6px}
.release + .release{margin-top:10px}
.releasedate{margin:0; font-size:13px; font-weight:700; color:var(--muted)}
.releaselist{margin:0; padding-left:18px; display:grid; gap:5px}
.releaselist li{padding:0}
